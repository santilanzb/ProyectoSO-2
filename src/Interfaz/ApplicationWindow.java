...
public class ApplicationWindow extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(character1ImageLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(410, 200, -1, -1));

        character2ImageLabel.setText("jLabel5");
        getContentPane().add(character2ImageLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(760, 200, -1, -1));
        ...
        getContentPane().add(jSlider2, new org.netbeans.lib.awtextra.AbsoluteConstraints(980, 30, -1, -1));

        jLabel4.setFont(new java.awt.Font("Dialog", 1, 18)); // NOI18N
        jLabel4.setForeground(new java.awt.Color(0, 0, 0));
        jLabel4.setText("10");
        getContentPane().add(jLabel4, new org.netbeans.lib.awtextra.AbsoluteConstraints(1150, 60, -1, -1));
